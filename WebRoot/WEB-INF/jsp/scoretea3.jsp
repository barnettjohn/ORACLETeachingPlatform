...
<body>
	...
	<div id="content">
		<div id="content-header">
			<div id="breadcrumb">
				<a href="${pageContext.request.contextPath}/servlet/IndexUIServlet"
					...
					href="#">评分模块</a><a href="${pageContext.request.contextPath}/servlet/ScoreUIServlet?flag=3"
					class="current" class="current">分数统计</a>
			</div>
			<h1 style="font-family: Microsoft Yahei">分数统计</h1>
		</div>
		<div class="container-fluid">
			...
			<div class="row-fluid">
				<div class="span12">
					<form action="${pageContext.request.contextPath}/servlet/DownloadServlet" method="post" class="form-horizontal">
								<input type="hidden" id="exportExcel" name="exportExcel" value="123"/>
								<div class="form-actions">
									<button id="submit_question" type="submit" class="btn btn-success">下载评分表</button>
					            </div>
							</form>
					<div class="widget-box" >
			        	<div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
							<h5>各学生分数</h5><span class="label  label-inverse"><!-- <i class="icon-pencil"></i><a class="tipdownload">生成评分表</a> --></span>
						</div>
 ...
 -->								    </tr>
								  ...
								  <c:forEach var="score" items="${allscorelist}">
									<tr class="gradeX" >
										...
										<td style="text-align:center">${score.stu}</td>
										<td style="text-align:center">${score.tea}</td>
