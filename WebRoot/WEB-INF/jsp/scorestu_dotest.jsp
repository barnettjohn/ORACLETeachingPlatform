		...
		<div id="content-header">
			<div id="breadcrumb">
				<a href="${pageContext.request.contextPath}/servlet/IndexUIServlet"
					...
					href="#">评价模块</a><a href="${pageContext.request.contextPath}/servlet/ScoreUIServlet?flag=1"
					class="current" class="current">学生评分</a><a href="${pageContext.request.contextPath}/servlet/GetStuScoreServlet?formid=${formid}&pid=${pid}"
					class="current" class="current">评价</a>
			</div>
			<h1 style="font-family: Microsoft Yahei">评价</h1>
		</div>
				...
				<div class="span12">
					 <div class="widget-box">
				        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
				          <h5>评分表：${form.fname}</h5>
				        </div>
				        <div class="widget-content nopadding updates">
				          <form action="${pageContext.request.contextPath}/servlet/DoStuScoreServlet" method="post" class="form-horizontal">
				            ...
				            <label class="control-label"></label>
				             ...
				             <c:forEach var="q" items="${form.formquestionList}">
					            <div class="control-group">
						            <div class="new-update clearfix">
							            <div class="update-done">
								            <strong>题目：${q.content}</strong> 
								            <span>难度（分数权重）：${q.power}</span>
								            <span>输入：<input type="text" id="q_${q.power}_${q.formqid}" name="q_${q.power}_${q.formqid}" placeholder="max<=10"></span>
