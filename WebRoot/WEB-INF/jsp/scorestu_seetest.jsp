		...
		<div id="content-header">
			<div id="breadcrumb">
				<a href="${pageContext.request.contextPath}/servlet/IndexUIServlet"
					...
					class="current" class="current">学生评分</a><a href="${pageContext.request.contextPath}/servlet/ScoreDetailServlet?formid=${formid}&pid=${pid}"
					class="current" class="current">评分详情</a>
			</div>
			<h1 style="font-family: Microsoft Yahei">评分详情</h1>
		</div>
				             ...
				             <div class="control-group">
					            <div class="new-update clearfix">
						            <div class="update-done">
							            <span>被评论人：${stuscore.p.pname}</span>
							        
							            <span>评分：${stuscore.score}</span>
							        </div>
