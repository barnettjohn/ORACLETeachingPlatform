...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">欢迎${person.pname}老师</span><b class="caret"></b></a>
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb span4"> <a href="${pageContext.request.contextPath}/servlet/ResourceUIServlet"> <i class="icon-signal"></i>资源管理</a> </li>
        <li class="bg_ly span6"> <a href="${pageContext.request.contextPath}/servlet/CourseUIServlet"> <i class="icon-inbox"></i><span class="label label-success">101</span> 课程设置 </a> </li>
        <li class="bg_lr span6"> <a href="${pageContext.request.contextPath}/servlet/TestUIServlet?flag=1"> <i class="icon-pencil"></i>测试模块</a> </li>
        <li class="bg_lg span4"> <a href="${pageContext.request.contextPath}/servlet/ScoreUIServlet?flag=1"> <i class="icon-th"></i> 评分模块</a> </li>
