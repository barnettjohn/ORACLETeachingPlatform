  ...
  <body>
	...
	<div id="sidebar">
		...
		<ul>
			...
			<li><a
				href="${pageContext.request.contextPath}/servlet/UIServlet"><i
					class="icon icon-th"></i> <span>评分模块</span></a></li>
			<li class="submenu"><a href="#"><i
					class="icon icon-file"></i> <span>测试模块</span></a>
				<ul>
   ...
   <div class="widget-box collapsible">
		...
		<%-- <script src="${pageContext.request.contextPath}/js/test.js"></script> --%>
			        ...
			        /* $("#submit_question").click(function() {
			            ...
			            $.post("/ORACLETeachingPlatform/servlet/GetTestQuestionAjaxServlet", $("#questionlist").serialize(), function(data, textStatus) {
